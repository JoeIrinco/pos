...
class StoreInvoiceController extends Controller
{
    ...
    public function index()
    {
            ...
            return view('templates.store-invoice');
    ...
    public function print($id)
    {
        ...
        //$items=Item::where('orders_id','=',$id)->get(); //old but good
        $items=StoreItem::where('orders_id','=',$id)->get();

        //$pdf = \PDF::loadView('templates.default', compact('order'));  //old but good
        $pdf = \PDF::loadView('templates.store-invoice'/* , compact('order') */);
    ...
    public function printPDF($id)
    {
        ...
        $orders=\DB::table('store_orders')->where('id',$id)->first();
        $getpurchasenumber=\DB::table('store_items')->where('orders_id',$id)->first();
        ...
        ->get();
        $pdf = \PDF::loadView('templates.store-invoice', compact('items','orders','getpurchasenumber'));
