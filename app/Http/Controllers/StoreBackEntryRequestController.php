...
class StoreBackEntryRequestController extends Controller
{
    /**
    ...
    {
        return view('store.back-entry');
    }

        //get datatable items
    public function storeBackEntryRequest(Request $request)
    {   
        $columns = array(
                ...
                <div class='btn-group task-list-action'>
                    <div class='dropdown '>
                        ...
                        <div class='dropdown-menu dropdown-menu-right'>
                            <a id='approved' class='dropdown-item' href='#' data-id='{$item->id}' ><i class='icon-paper-plane text-success pr-2'></i> Approved</a>
...
/* 
    ...
    function processBackEntry(Request $request)
    {
        
        $stat = DB::table('store_orders')->where('id', $request->id)->update(['status' => "COMPLETED"]);
