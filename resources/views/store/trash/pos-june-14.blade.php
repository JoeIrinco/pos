...
{{-- newwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww --}}
            ...
            <div id="div_hide_second">
                                    ...
                                    {{-- <div id="div_third" class=" col-md-6 mt-1" style="display: none">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" id="input_payment_status" class="text-uppercase form-control" hidden readonly>
                                                        ...
                                                        <select style="border-color: rgb(0, 0, 0);"  id="payment_type" class="form-control" > onchange="yesnoCheck(this);"
                                                            <option value=''>SELECT TRANSACTION TYPE</option>
                                                            <option value='value_cash'>CASH</option>
                                                            <option value='value_check'>CHECK</option>
                                                            <option value='value_debit'>CARD -> DEBIT</option>
                                                            ...
                                                            <option value='value_paymaya'>ONLINE PAYMENT -> PAYMAYA</option>
                                                            <option value='value_deposit'>ONLINE PAYMENT -> DEPOSIT</option>
                                                            <option value='value_online_transfer'>ONLINE PAYMENT -> ONLINE TRANSFER</option>
                                                        </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="card-body col-md-4 mb-3">
                                                    <div class="alert alert-success" role="alert">
                                                        <p class="mb-1">VAT EXEMPT :</p>
                                                        
                                                        <hr>
                                                        <h4 id="h4_vat_exempt" class="alert-heading"></h4>
                                                    </div>
                                                </div>
                                                <div class="card-body col-md-4 mb-3">
                                                    <div class="alert alert-success" role="alert">
                                                        ...
                                                        <hr>
                                                        <h4 id="h4_total" class="alert-heading"></h4>
                                                    </div>
                                                </div>
                        ...
                        success:function(data){
                            ...
                            if(type === 'si_senior'){
                               ...
                               $('#h4_total').val(data.total);
                                ...
                                $('#h4_final_total').val(data.total);
                                var finaltotal = parseInt($("#h4_final_total").val());
                                $('#h4_final_total').text(parseFloat(data.total).toFixed(2));
