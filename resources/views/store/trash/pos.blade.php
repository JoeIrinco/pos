...
{{-- newwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww --}}
                                ...
                                <div class="row" >
                                        ...
                                        <div id="div_transaction_information_content" style="display: none;">
                                            {{-- <div class="row" >
                                                <div id="div_terms" style="display: none;" class="col-md-3 mb-3">
                                                    ...
                                                    <select style="border-color: rgb(0, 0, 0);" id="input_terms" class="form-control" >
                                    ...
                                    <div id="div_second" class=" col-md-6 mt-1 mb-1" style="display: none"> {{-- start --}}
            ...
            <div id="div_hide_second">
                                    ...
                                    <div id="div_third" style="display: none;">
                                            ...
                                            <div class="row">
                                                {{-- <strong><label>Document Type:</label></strong> --}}
                                                ...
                                                <div id="div_payment_atc1" style="display: none;" class="col-md-6 ">
                                                    ...
                                                    <select style="width:100%;" id="atcSelect" data-placeholder='-- Select Product --' class="form-control"  name="product_name[]">
                                                        <option value='0'>-- Select ATC --</option>
                                                        <option value='0'>WI158 1%</option>
                                                        <option value='0'>WI640 1%</option>
                                                        <option value='0'>WC158 1%</option>
                                                        <option value='0'>WC640 1%</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div id="div_payment_type" style="display: none;">
                                                ...
                                                <div class="row" >
                                                    ...
                                                    <div id="div_other_bank" style="display: none;" class="col-md-4 mb-3">
                                                        ...
                                                        {{-- <input type="text" id="input_other_bank"  style="border-color: rgb(0, 0, 0);" class="text-uppercase form-control" > --}}
                                            ...
                                            <div class="row">
                                                ...
                                                {{-- <div id="div_total" class=" col-md-4 mb-3" style="display: block">
                                                    <div class="alert alert-success" role="alert">
                                                        <p class="mb-1">Total Sales (VAT Inclusive) :<h4  class="alert-heading" id="h4_total">{{ $format = number_format($sell) }}</h4></p>
                                                        
                                                        
                                                    </div>
                                                </div> --}}
                                                {{-- <div id="div_vat" class="col-md-4 " style="display: none">
                                                    <div class="alert alert-success" role="alert">
                                                        <p class="mb-1">VAT :<h4 id="h4_vat" class="alert-heading"></h4></p>
                                                        
                                                        
                                                    </div>
                                                </div> --}}
                                                {{-- <div id="div_net_of_vat" class="col-md-4" style="display: none">
                                                    <div class="alert alert-success" role="alert">
                                                        <p class="mb-1">NET OF VAT :<h4 id="h4_net_of_vat" class="alert-heading"></h4></p>
                                                        
                                                        
                                                    </div>
                                                </div> --}}
                                                {{-- <div id="div_vat_exempt_sales" class="col-md-4" style="display: none">
                                                    <div class="alert alert-success" role="alert">
                                                        <p class="mb-1">VAT EXEMPT SALES:<h4 id="h4_vat_exempt_sales" class="alert-heading"></h4></p>
                                                        
                                                        
                                                    </div>
                                                </div> --}}
                                                {{-- <div id="div_discount" class="col-md-4" style="display: none">
                                                    <div class="alert alert-success" role="alert">
                                                        <p class="mb-1">DISCOUNT:<h4 id="h4_discount" class="alert-heading"></h4></p>
                                                        
                                                        
                                                    </div>
                                                </div> --}}
                                                {{-- <div id="div_ewt" id="" class="col-md-4 " style="display: none">
                                                    <div class="alert alert-success" role="alert">
                                                        <p class="mb-1">EWT :<h4 id="ewt" class="alert-heading"></h4></p>
                                                ...
                                                {{-- <div class="col-md-12">
                                                    <div class="alert alert-success" role="alert">
                                                        <p class="mb-1">TOTAL AMOUNT DUE :<h4 id="h4_final_total" class="alert-heading"></h4></p>
 ...
 $(document).ready(function(){
    ...
    console.log('typeeee is'+type);
            $('#show-hide').DataTable({
                ...
                /* var ttype = $("#input_transaction_type").val(); */
                /* console.log(prod_id); null value */
                
                $.ajax({
                    type:'get',
                    url:'{{ url('storefindClientList') }}',
                    data:{'id':prod_id/* ,'ttype':ttype */},
                    dataType:'json',//return data will be json
                    success:function(data){
    ...
    $(document).on('click','#first_to_second',function () { /* zzz */
            ...
            if(ifnull_transaction_type === ''){
                ...
                }if(ifnull_transaction_type === 'of_private'){
                        if(b && c && d && e != ''){
