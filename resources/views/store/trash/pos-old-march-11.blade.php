...
<script src="https://cdn.datatables.net/1.10.23/js/jquery.dataTables.min.js"></script> --}}
   ...
   <!--jquery validate-->
   <script src="public/css2/dist/jquery.validate.js"></script>

   <!--jquery steps-->
   <script src="public/css2/vendor/jquery-steps/jquery.steps.min.js"></script>

   <!--jquery stepy-->
   <script src="public/css2/vendor/jquery-steps/jquery.stepy.js"></script>
