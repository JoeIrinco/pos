                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                            @foreach($transaction_histories as $transaction_historie)
                                            <tr>
                                                <td>{{ $loop->iteration}}</td>
                                                <td>{{ $transaction_historie->transaction_id}}</td>
                                                <td>{{ $transaction_historie->invoice_no}}</td>
                                                <td>{{ $transaction_historie->payment_type}}</td>
                                                <td>{{ $transaction_historie->check_no}}</td>
                                                <td>{{ $transaction_historie->check_date}}</td>
                                                <td>{{ $transaction_historie->bank}}</td>
                                                <td>{{ $transaction_historie->ref_no}}</td>
                                                <td>{{ $transaction_historie->account_name}}</td>
                                                <td>{{ $transaction_historie->date}}</td>
                                                <td>{{ $transaction_historie->total_payment}}</td>{{-- old value is amount replace by total_payment --}}
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
