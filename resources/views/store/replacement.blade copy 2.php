...
<script>
    ...
    $(document).on('click', '#select_rock', function(){
        //$('#modal_body_save').modal("show");
        var len = document.getElementById("select_rock").length;
        /* alert(len); */
        if(len <= 1){
    ...
    $(document).on('click', '#select_shelf', function(){
        var len = document.getElementById("select_shelf").length;
        /* alert(len); */
        if(len <= 1){
            $('#select_shelf').append(`<option value="Shelf 1">Shelf 1</option>`,
    ...
    $(document).on('click','.replaced_item',function () {
        ...
        formData.append("select_rack", $("#select_rock").val());
        ...
        $(document).on('change',productselect,function () {
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $.each( data.shelfs, function( key, value ) {
                        $('#select_shelf2').append($("<option/>", {
                            value: value,
                            text: value
                        }));
                    });
                    $.each( data.rocks, function( key, value ) {
