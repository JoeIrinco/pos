                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li class="sub-menu">
                                    ...
                                    <li><a href="orders">Add Client</a></li>
                    ...
                    <tbody>
                        ...
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="employee/{{$item->id}}" class="btn btn-primary shadow btn-s sharp mr-1">{{-- <i class="fa fa-eye"></i> --}}View</a>
                                        {{-- <a href="/printDirect/{{$orders->id}}" class="btn btn-success  btn-m sharp mr-1">Print</a> --}}
                                        {{-- <a href="printPDF/{{$item->id}}" class="btn btn-info  btn-m shadow sharp mr-1"> --}}{{-- <i class="fa fa-pencil"></i> --}}{{-- <i class="fa fa-download"></i></a> --}}
