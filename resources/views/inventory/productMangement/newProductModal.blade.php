                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                   {{--  <label for="branch_add">Branch</label>
                                    ...
                                    <label for="branch_add">Branch</label>
                                    <select name="branch_add" class="form-control">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="brand_add" id="brand_add"placeholder="Brand Name" value="" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="product_code_add" id="product_code_add"  placeholder="Product Code" value="">
                                    <div class="invalid-feedback">
