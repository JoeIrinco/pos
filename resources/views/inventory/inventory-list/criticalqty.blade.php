...
@section('title','Home | Product Critical level List')
@section('page-title','Product Critical level List')
            ...
            <div class="row">
                <div class="col-8">
                    <h4 class="mb-0"> Dashboard
                        <small>Product Critical level List</small>
                    </h4>
                    <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                        <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                        <li class="breadcrumb-item active">Product Critical level List</li>
                    </ol>
                </div>
...
{{-- modal --}}
      ...
      <script src="{{asset('public/assets/js/inventory/criticalProducts.js?v=1')}}"></script>
      <script type="text/javascript">
        ...
        $('body').on('click', '#print_inventory', function() {
            /* alert("Not Yet Ready"); */
        window.open('../inventory/product-data-critacal-pdf');        
        });
      </script>
