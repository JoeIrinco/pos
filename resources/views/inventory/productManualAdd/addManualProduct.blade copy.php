                    ...
                    <div class="card-body product_id1">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" style="" class="form-control  POnumber required_input"  name="POnumber" id="POnumber" placeholder="PO Number" value="" required>                                          
                                <div class="invalid-feedback">Please provide a valid PO Number.</div>
                            </div>
                            <div class="col-md-4 mb-3">                                   
                                <label for="po_num">Invoice Number</label>
                                <input type="text" style="" class="form-control  invoice_number required_input"  name="invoice_number" id="invoice_number" placeholder="Invoice Nnumber" value="" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">                                   
                                ...
                                <input type="number" style="" class="form-control OrderPrice_data OrderPrice required_input"  name="OrderPrice" id="OrderPrice" placeholder="0" value="" required>
                            </div>
                            <div class="col-md-3 mb-3">                                   
                                <label for="action_state">Action</label>
                                <select class="form-control" name="action_state" id="action_state">
                                    <option value="" selected disabled>Select Action</option>
                                    <option value="Add">Add Product Quantity Manually</option>
                            ...
                            <div class="form_location col-md-12">
                                ...
                                <div class="productId">
                                    ...
                                    <div class="row set_2">
                                        <div class="col-md-2 mb-3">
                                            <label for="po_num">Quantity</label>
                                            <input type="number" class="required_input form-control qunatity_po qunatity_po_tr qunatity_po_function"  name="Quantity_po"
                                            ...
                                            <div class="col-md-2 mb-3 lotDiv">
                                                ...
                                                <select name="lot_no" id="lot_no" class="form-control lot_no required_input" required>
                                                    <option value="">Select Please</option>
                                                    @foreach ($lots as $lot)
                                                        <option  value="{{$lot->lot_no}}">{{$lot->lot_no}}</option>
                                                    @endforeach
                                            ...
                                            <div class="col-md-2 expirationDiv">
                                                ...
                                                <select name="exp_date" id="exp_date" class="form-control location_po required_input" required>
                                               ...
                                               {{--  <div class="ccol-md-4 mb-3">
                                                    <div class="input-group date dpYears" data-date-viewmode="years"
                                                        data-date-format="dd-mm-yyyy" data-date="{{ $now }}">
                                                        <input type="text" class="required_input form-control exp_date" id="exp_date"
                                                            placeholder="{{ $now }}" aria-label="Right Icon"
                                                            aria-describedby="dp-ig">
                                                        <div class="input-group-append">
                                                            <button id="dp-ig" class="btn btn-outline-secondary"
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <select name="location_po" id="location_po" class="form-control location_po required_input" required>
                                                <option value="">Select Please</option>
                                                @foreach ($locations as $location)
                                                    <option  value="{{$location->location}}">{{$location->location}}</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-2 mb-3">
                                            <label for="po_num">Rack</label>
                                            <select name="rock_po" id="rock_po" class="form-control rock_po required_input" required>
                                                <option value="">Select Please</option>
                                                @foreach ($racks as $rack)
                                                    <option  value="{{$rack->rack}}">{{$rack->rack}}</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <select name="shelf_po" id="shelf_po" class="form-control shelf_po required_input" required>
                                                <option value="">Select Please</option>
                                                @foreach ($shelf_locations as $shelf_location)
                                                    <option   value="{{$shelf_location->shelf}}">{{$shelf_location->shelf}}</option>
                                                @endforeach
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-12">
                                        ...
                                        <textarea class="form-control" id="remarks_manual_action" cols="10" rows="5"></textarea>
                                    </div>
                       ...
                       var id = $(this).val();
                        ...
                        $.ajax({
                           ...
                           success:function(data){
                            ...
                            var rock=0;
                            var shelf_inner=0
                            $('#lot_no').empty().append('<option selected="selected" value="">Select Please</option>');
                            $('#location_po').empty().append('<option selected="selected" value="">Select Please</option>');
                            $('#rock_po').empty().append('<option selected="selected" value="">Select Please</option>');
                            $('#shelf_po').empty().append('<option selected="selected" value="">Select Please</option>');
                            $.each(data.transaction_items_lot, function (i, item) {
