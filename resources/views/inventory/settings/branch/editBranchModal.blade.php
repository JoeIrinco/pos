        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                        ...
                        <form  method="POST"  class="container" id="BranchForm_edit" enctype="multipart/form-data" novalidate>
                            @csrf
                            <input type="hidden" class="form-control" name="id_edit" id="id_edit" placeholder="Branch" value="" required>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="branch_edit">Branch</label>
                                    <input type="text" class="form-control" name="branch_edit" id="branch_edit" placeholder="Branch" value="" required>
...
<script>
    $( document ).ready(function() {
        $("input[type=text]").keyup(function () {  
            ...
            $('body').on('submit', '#BranchForm_edit', function (event) {
                
            event.preventDefault();
            console.log('Branch Add submitting...');
            $.ajax({
                url: "{{ url('inventory/edit-branch') }}",
                type: 'POST',
                ...
                success: function (response) {
                    console.log('branch Updating submitting success...');
                    $('.send-loading').hide();
                    swal({
                        title: 'Success!',
