{{-- @foreach ($productlists as $product_name)
    <p>This is user {{ $product_name->item_number }} {{ $product_name->product_name }} {{ $product_name->unit }}</p>
@endforeach --}}
			...
			<div class="fixed-content-body dz-scroll" id="DZ_W_Fixed_Contant">
				...
				<div class="tab-pane chart-sidebar fade show active" role="tabpanel">
					...
					<div class="card bg-info-light">
						...
						<div class="card-body">
							<p class="mb-2 d-flex"><img width="22" height="22" src="images/browser/icon1.png" class="mr-2" alt=""/>Photoshop
							...
							<p class="mb-2 d-flex"><img width="22" height="22" src="images/browser/icon2.png" class="mr-2" alt=""/>Code editor
							...
							<p class="mb-2 d-flex"><img width="22" height="22" src="images/browser/icon1.png" class="mr-2" alt=""/>Illustrator
